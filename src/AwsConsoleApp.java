...
public class AwsConsoleApp {
     ...
     *      (C:\\Users\\Sandeep\\.aws\\credentials) where the sample code will load the
     *      credentials from.
    ...
    private static void init() throws Exception {
        ...
        /*
         * The ProfileCredentialsProvider will return your [SandeepAgiliad]
         * credential profile by reading from the credentials file located at
         * (C:\\Users\\Sandeep\\.aws\\credentials).
         */
        AWSCredentials credentials = null;
        try {
            credentials = new ProfileCredentialsProvider("SandeepK").getCredentials();
        } catch (Exception e) {
            throw new AmazonClientException(
                    "Cannot load the credentials from the credential profiles file. " +
                    "Please make sure that your credentials file is at the correct " +
                    "location (C:\\Users\\Sandeep\\.aws\\credentials), and is in valid format.",
                    e);
        }
